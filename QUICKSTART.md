...
- Add ordered items (like firewall rules): `cfg add "firewall.input_rules.[0] comment='Allow SSH' service=ssh action=accept" -p 0`
...
- Delete list items by index: `cfg del firewall.input_rules.[2]`
